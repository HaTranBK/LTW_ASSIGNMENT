...
<nav class="navbar navbar-expand-lg bg-light shadow-sm p-3 mb-5 bg-body rounded">
  <div class="container-fluid">
    <a class="navbar-brand" href="<?php echo $rootPath ?>">
        <img src="<?php echo $adminSettings['logo']; ?>" alt="Logo" width="70" height="30" class="d-inline-block align-text-top">
    </a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="<?php echo $rootPath?>/settings/">Cài đặt</a></li>
